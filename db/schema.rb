...
ActiveRecord::Schema[7.0].define(version: 20_220_215_092_638) do
  ...
  create_table 'items', force: :cascade do |t|
    ...
    t.index %w[target_type target_id], name: 'index_items_on_target'
  end
  ...
  create_table 'lmia_jobs', force: :cascade do |t|
    t.bigint 'company_id', null: false
    t.bigint 'noc_id', null: false
    t.bigint 'program_stream_id', null: false
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['company_id'], name: 'index_lmia_jobs_on_company_id'
    t.index ['noc_id'], name: 'index_lmia_jobs_on_noc_id'
    t.index ['program_stream_id'], name: 'index_lmia_jobs_on_program_stream_id'
  end
  ...
  add_foreign_key 'lmia_jobs', 'companies'
  add_foreign_key 'lmia_jobs', 'nocs'
  add_foreign_key 'lmia_jobs', 'program_streams'
